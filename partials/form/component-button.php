...
<section class="rounded-3xl bg-gradient-to-r from-[#1c54db] to-[#0b4f81] p-6 text-white shadow-card" data-component="booking-actions">
    <div class="flex flex-wrap items-center justify-between gap-6">
        ...
        <button type="submit"
                class="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3 text-base font-semibold text-[#0b4f81] shadow-lg shadow-slate-900/10 transition hover:bg-slate-100"
